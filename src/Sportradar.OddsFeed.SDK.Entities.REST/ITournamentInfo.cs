...
namespace Sportradar.OddsFeed.SDK.Entities.REST
{
    ...
    public interface ITournamentInfo
    {
        ...
        /// <summary>
        ///     Gets a <see cref="IReadOnlyDictionary{TKey,TValue}" /> containing names of the season in different languages
        /// </summary>
        ...
        /// <summary>
        ///     Gets the <see cref="ICurrentSeasonInfo" /> which contains data for the season in which the current tournament is
        ///     happening
        /// </summary>
        /// <value>
        ///     The <see cref="ICurrentSeasonInfo" /> which contains data for the season in which the current tournament is
        ///     happening
        /// </value>
