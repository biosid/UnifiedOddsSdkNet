...
namespace Sportradar.OddsFeed.SDK.Entities.REST.Internal
{
    ...
    internal class DataRouterManager : IDataRouterManager
    {
        ...
        ///     An <see cref="Common.ExceptionHandlingStrategy" /> used to handle exception
        ///     when fetching data
        /// </param>
        ...
        public async Task GetSportEventSummaryAsync(URN id, CultureInfo culture, ISportEventCI requester)
        {
            ...
            {
                WriteLog(
                    $"Executing GetSportEventSummaryAsync for id={id} and culture={culture.TwoLetterISOLanguageName}.",
                    true);
                ...
                catch (Exception e)
                {
                    ...
                    _executionLog.Error(
                        $"Error getting sport event summary for id={id} and lang:[{culture.TwoLetterISOLanguageName}]. Message={message}",
                        e.InnerException ?? e);
                    if (ExceptionHandlingStrategy == ExceptionHandlingStrategy.THROW) throw;
                }
                ...
                WriteLog(
                    $"Executing GetSportEventSummaryAsync for id={id} and culture={culture.TwoLetterISOLanguageName} took {restCallTime} ms.{SavingTook(restCallTime, (int) t.Elapsed.TotalMilliseconds)}");
            }
        }
        ...
        /// <param name="requester">The cache item which invoked request</param>
        /// <returns>Task</returns>
        public async Task GetSportEventFixtureAsync(URN id, CultureInfo culture, bool useCachedProvider,
            ISportEventCI requester)
        {
            ...
            {
                WriteLog(
                    $"Executing {(useCachedProvider ? "cached" : "non-cached")} GetSportEventFixtureAsync for id={id} and culture={culture.TwoLetterISOLanguageName}.",
                    true);
                ...
                try
                {
                    ...
                    result = await provider.GetDataAsync(id.ToString(), culture.TwoLetterISOLanguageName)
                        .ConfigureAwait(false);
                    restCallTime = (int) t.Elapsed.TotalMilliseconds;
                }
                catch (Exception e)
                {
                    ...
                    var message = e.InnerException?.Message ?? e.Message;
                    _executionLog.Error(
                        $"Error getting sport event fixture for id={id} and lang:[{culture.TwoLetterISOLanguageName}]. Message={message}",
                        e.InnerException ?? e);
                    if (ExceptionHandlingStrategy == ExceptionHandlingStrategy.THROW) throw;
                }

                if (result != null)
                    await _cacheManager.SaveDtoAsync(id, result, culture, DtoType.Fixture, requester)
                        .ConfigureAwait(false);
                WriteLog(
                    $"Executing GetSportEventFixtureAsync for id={id} and culture={culture.TwoLetterISOLanguageName} took {restCallTime} ms.{SavingTook(restCallTime, (int) t.Elapsed.TotalMilliseconds)}");
            }
        }
        ...
        public async Task GetAllTournamentsForAllSportAsync(CultureInfo culture)
        {
            ...
            {
                WriteLog($"Executing GetAllTournamentsForAllSportAsync for culture={culture.TwoLetterISOLanguageName}.",
                    true);
                ...
                try
                {
                    result = await _allTournamentsForAllSportsProvider.GetDataAsync(culture.TwoLetterISOLanguageName)
                        .ConfigureAwait(false);
                    restCallTime = (int) t.Elapsed.TotalMilliseconds;
                }
                catch (Exception e)
                {
                    ...
                    var message = e.InnerException?.Message ?? e.Message;
                    _executionLog.Error(
                        $"Error getting all tournaments for all sports for lang:[{culture.TwoLetterISOLanguageName}]. Message={message}",
                        e.InnerException ?? e);
                    if (ExceptionHandlingStrategy == ExceptionHandlingStrategy.THROW) throw;
                }

                if (result != null && result.Items.Any())
                    await _cacheManager.SaveDtoAsync(URN.Parse($"sr:sports:{result.Items.Count()}"), result, culture,
                        DtoType.SportList, null).ConfigureAwait(false);
                WriteLog(
                    $"Executing GetAllTournamentsForAllSportAsync for culture={culture.TwoLetterISOLanguageName} took {restCallTime} ms.{SavingTook(restCallTime, (int) t.Elapsed.TotalMilliseconds)}");
            }
        }
        ...
        public async Task GetSportCategoriesAsync(URN id, CultureInfo culture)
        {
            ...
            {
                WriteLog(
                    $"Executing GetSportCategoriesAsync for id={id} and culture={culture.TwoLetterISOLanguageName}.",
                    true);
                ...
                try
                {
                    result = await _sportCategoriesProvider
                        .GetDataAsync(id.ToString(), culture.TwoLetterISOLanguageName).ConfigureAwait(false);
                    restCallTime = (int) t.Elapsed.TotalMilliseconds;
                }
                catch (Exception e)
                {
                    ...
                    var message = e.InnerException?.Message ?? e.Message;
                    _executionLog.Error(
                        $"Error getting sport categories for id={id} and lang:[{culture.TwoLetterISOLanguageName}]. Message={message}",
                        e.InnerException ?? e);
                    if (ExceptionHandlingStrategy == ExceptionHandlingStrategy.THROW) throw;
                }

                if (result?.Categories != null)
                    await _cacheManager.SaveDtoAsync(id, result, culture, DtoType.SportCategories, null)
                        .ConfigureAwait(false);
                WriteLog(
                    $"Executing GetSportCategoriesAsync for id={id} and culture={culture.TwoLetterISOLanguageName} took {restCallTime} ms.{SavingTook(restCallTime, (int) t.Elapsed.TotalMilliseconds)}");
            }
        }
        ...
        public async Task GetAllSportsAsync(CultureInfo culture)
        {
            ...
            using (var t = timer.NewContext($"{culture.TwoLetterISOLanguageName}"))
            {
                ...
                try
                {
                    result = await _allSportsProvider.GetDataAsync(culture.TwoLetterISOLanguageName)
                        .ConfigureAwait(false);
                    restCallTime = (int) t.Elapsed.TotalMilliseconds;
                }
                catch (Exception e)
                {
                    ...
                    var message = e.InnerException?.Message ?? e.Message;
                    _executionLog.Error(
                        $"Error getting all sports for lang:[{culture.TwoLetterISOLanguageName}]. Message={message}",
                        e.InnerException ?? e);
                    if (ExceptionHandlingStrategy == ExceptionHandlingStrategy.THROW) throw;
                }
                ...
                if (result != null && result.Items.Any())
                    await _cacheManager.SaveDtoAsync(URN.Parse($"sr:sports:{result.Items.Count()}"), result, culture,
                        DtoType.SportList, null).ConfigureAwait(false);
                WriteLog(
                    $"Executing GetAllSportsAsync for culture={culture.TwoLetterISOLanguageName} took {restCallTime} ms.{SavingTook(restCallTime, (int) t.Elapsed.TotalMilliseconds)}");
            }
        }
        ...
        public async Task<IEnumerable<Tuple<URN, URN>>> GetLiveSportEventsAsync(CultureInfo culture)
        {
            ...
            using (var t = timer.NewContext($"{culture.TwoLetterISOLanguageName}"))
            {
                ...
                try
                {
                    result = await _sportEventsForDateProvider.GetDataAsync(culture.TwoLetterISOLanguageName)
                        .ConfigureAwait(false);
                    restCallTime = (int) t.Elapsed.TotalMilliseconds;
                }
                catch (Exception e)
                {
                    ...
                    var message = e.InnerException?.Message ?? e.Message;
                    _executionLog.Error(
                        $"Error getting live sport events and lang:[{culture.TwoLetterISOLanguageName}]. Message={message}",
                        e.InnerException ?? e);
                    if (ExceptionHandlingStrategy == ExceptionHandlingStrategy.THROW) throw;
                }
                ...
                if (result != null && result.Items.Any())
                {
                    await _cacheManager.SaveDtoAsync(URN.Parse($"sr:sportevents:{result.Items.Count()}"), result,
                        culture, DtoType.SportEventSummaryList, null).ConfigureAwait(false);
                    var urns = new List<Tuple<URN, URN>>();
                    foreach (var item in result.Items) urns.Add(new Tuple<URN, URN>(item.Id, item.SportId));
                    WriteLog(
                        $"Executing GetLiveSportEventsAsync for culture={culture.TwoLetterISOLanguageName} took {restCallTime} ms.{SavingTook(restCallTime, (int) t.Elapsed.TotalMilliseconds)}");
                    return urns;
                }
            }
        ...
        public async Task<IEnumerable<Tuple<URN, URN>>> GetSportEventsForDateAsync(DateTime date, CultureInfo culture)
        {
            ...
            {
                WriteLog(
                    $"Executing GetSportEventsForDateAsync for date={date.ToShortDateString()} and culture={culture.TwoLetterISOLanguageName}.",
                    true);
                ...
                try
                {
                    result = await _sportEventsForDateProvider.GetDataAsync(dateId, culture.TwoLetterISOLanguageName)
                        .ConfigureAwait(false);
                    restCallTime = (int) t.Elapsed.TotalMilliseconds;
                }
                catch (Exception e)
                {
                    ...
                    var message = e.InnerException?.Message ?? e.Message;
                    _executionLog.Error(
                        $"Error getting sport events for date {dateId} and lang:[{culture.TwoLetterISOLanguageName}]. Message={message}",
                        e.InnerException ?? e);
                    if (ExceptionHandlingStrategy == ExceptionHandlingStrategy.THROW) throw;
                }
                ...
                if (result != null && result.Items.Any())
                {
                    ...
                    foreach (var item in result.Items) urns.Add(new Tuple<URN, URN>(item.Id, item.SportId));
                    WriteLog(
                        $"Executing GetSportEventsForDateAsync for date={date.ToShortDateString()} and culture={culture.TwoLetterISOLanguageName} took {restCallTime} ms.{SavingTook(restCallTime, (int) t.Elapsed.TotalMilliseconds)}");
                    return urns;
                }
            }
        ...
        public async Task<IEnumerable<Tuple<URN, URN>>> GetSportEventsForTournamentAsync(URN id, CultureInfo culture,
            ISportEventCI requester)
        {
            ...
            {
                WriteLog(
                    $"Executing GetSportEventsForTournamentAsync for tournament id={id} and culture={culture.TwoLetterISOLanguageName}.",
                    true);
                ...
                try
                {
                    result = await _sportEventsForTournamentProvider
                        .GetDataAsync(id.ToString(), culture.TwoLetterISOLanguageName).ConfigureAwait(false);
                    restCallTime = (int) t.Elapsed.TotalMilliseconds;
                }
                catch (Exception e)
                {
                    restCallTime = (int) t.Elapsed.TotalMilliseconds;
                    var message = e.InnerException?.Message ?? e.Message;
                    if (!e.Message.Contains("No schedule for this tournament") &&
                        !e.Message.Contains("This is a place-holder tournament."))
                    {
                        _executionLog.Error(
                            $"Error getting sport events for tournament for id={id} and lang:[{culture.TwoLetterISOLanguageName}]. Message={message}",
                            e.InnerException ?? e);
                        if (ExceptionHandlingStrategy == ExceptionHandlingStrategy.THROW) throw;
                    }
                    else
                ...
                {
                    await _cacheManager.SaveDtoAsync(URN.Parse($"sr:sportevents:{result.Items.Count()}"), result,
                        culture, DtoType.SportEventSummaryList, requester).ConfigureAwait(false);
                    var urns = new List<Tuple<URN, URN>>();
                    foreach (var item in result.Items) urns.Add(new Tuple<URN, URN>(item.Id, item.SportId));
                    WriteLog(
                        $"Executing GetSportEventsForTournamentAsync for tournament id={id} and culture={culture.TwoLetterISOLanguageName} took {restCallTime} ms.{SavingTook(restCallTime, (int) t.Elapsed.TotalMilliseconds)}");
                    return urns;
                }
            }
        ...
        public async Task GetPlayerProfileAsync(URN id, CultureInfo culture, ISportEventCI requester)
        {
            ...
            {
                WriteLog(
                    $"Executing GetPlayerProfileAsync for id={id} and culture={culture.TwoLetterISOLanguageName}.");

                PlayerProfileDTO result = null;
                int restCallTime;
                try
                {
                    result = await _playerProfileProvider.GetDataAsync(id.ToString(), culture.TwoLetterISOLanguageName)
                        .ConfigureAwait(false);
                    restCallTime = (int) t.Elapsed.TotalMilliseconds;
                }
                catch (Exception e)
                {
                    ...
                    var message = e.InnerException?.Message ?? e.Message;
                    _executionLog.Error(
                        $"Error getting player profile for id={id} and lang:[{culture.TwoLetterISOLanguageName}]. Message={message}",
                        e.InnerException ?? e);
                    if (ExceptionHandlingStrategy == ExceptionHandlingStrategy.THROW) throw;
                }

                if (result != null && result.Id.Equals(id))
                    await _cacheManager.SaveDtoAsync(id, result, culture, DtoType.PlayerProfile, requester)
                        .ConfigureAwait(false);
                WriteLog(
                    $"Executing GetPlayerProfileAsync for id={id} and culture={culture.TwoLetterISOLanguageName} took {restCallTime} ms.{SavingTook(restCallTime, (int) t.Elapsed.TotalMilliseconds)}");
            }
        }
        ...
        public async Task GetCompetitorAsync(URN id, CultureInfo culture, ISportEventCI requester)
        {
            ...
            using (var t = timer.NewContext($"{id} [{culture.TwoLetterISOLanguageName}]"))
            {
                WriteLog($"Executing GetCompetitorAsync for id={id} and culture={culture.TwoLetterISOLanguageName}.",
                    true);
                ...
                try
                {
                    if (id.Type.Equals(SdkInfo.SimpleTeamIdentifier, StringComparison.InvariantCultureIgnoreCase)
                        || id.ToString().StartsWith(SdkInfo.OutcometextVariantValue,
                            StringComparison.InvariantCultureIgnoreCase))
                        simpleTeamResult = await _simpleTeamProvider
                            .GetDataAsync(id.ToString(), culture.TwoLetterISOLanguageName).ConfigureAwait(false);
                    else
                        competitorResult = await _competitorProvider
                            .GetDataAsync(id.ToString(), culture.TwoLetterISOLanguageName).ConfigureAwait(false);
                    restCallTime = (int) t.Elapsed.TotalMilliseconds;
                }
                catch (Exception e)
                {
                    ...
                    var message = e.InnerException?.Message ?? e.Message;
                    _executionLog.Error(
                        $"Error getting competitor profile for id={id} and lang:[{culture.TwoLetterISOLanguageName}]. Message={message}",
                        e.InnerException ?? e);
                    if (ExceptionHandlingStrategy == ExceptionHandlingStrategy.THROW) throw;
                }
                ...
                {
                    await _cacheManager
                        .SaveDtoAsync(id, simpleTeamResult, culture, DtoType.SimpleTeamProfile, requester)
                        .ConfigureAwait(false);
                    if (!simpleTeamResult.Competitor.Id.Equals(id))
                        await _cacheManager.SaveDtoAsync(simpleTeamResult.Competitor.Id, simpleTeamResult, culture,
                            DtoType.SimpleTeamProfile, requester).ConfigureAwait(false);
                }

                if (competitorResult != null && competitorResult.Competitor.Id.Equals(id))
                    await _cacheManager
                        .SaveDtoAsync(id, competitorResult, culture, DtoType.CompetitorProfile, requester)
                        .ConfigureAwait(false);
                WriteLog(
                    $"Executing GetCompetitorAsync for id={id} and culture={culture.TwoLetterISOLanguageName} took {restCallTime} ms.{SavingTook(restCallTime, (int) t.Elapsed.TotalMilliseconds)}");
            }
        }
        ...
        public async Task<IEnumerable<URN>> GetSeasonsForTournamentAsync(URN id, CultureInfo culture,
            ISportEventCI requester)
        {
            ...
            {
                WriteLog(
                    $"Executing GetSeasonsForTournamentAsync for tournament id={id} and culture={culture.TwoLetterISOLanguageName}.",
                    true);
                ...
                try
                {
                    result = await _tournamentSeasonsProvider
                        .GetDataAsync(id.ToString(), culture.TwoLetterISOLanguageName).ConfigureAwait(false);
                    restCallTime = (int) t.Elapsed.TotalMilliseconds;
                }
                catch (Exception e)
                {
                    ...
                    if (e.Message.Contains("No seasons for tournament") ||
                        e.Message.Contains("This is a place-holder tournament.") || e.Message.Contains("NotFound"))
                    {
                        message = message.Contains(".")
                            ...
                            : message;
                        _executionLog.Debug(
                            $"Error getting seasons for tournament id={id} and lang:[{culture.TwoLetterISOLanguageName}]. Message={message}");
                    }
                    else
                    {
                        _executionLog.Error(
                ...
                {
                    await _cacheManager
                        .SaveDtoAsync(result.Tournament.Id, result, culture, DtoType.TournamentSeasons, requester)
                        .ConfigureAwait(false);
                    if (result.Seasons != null)
                    {
                        var urns = new List<URN>();
                        foreach (var item in result.Seasons) urns.Add(item.Id);
                        WriteLog(
                            $"Executing GetSeasonsForTournamentAsync for tournament id={id} and culture={culture.TwoLetterISOLanguageName} took {restCallTime} ms.{SavingTook(restCallTime, (int) t.Elapsed.TotalMilliseconds)}");
                        return urns;
                    }
                }
            }
        ...
        public async Task GetInformationAboutOngoingEventAsync(URN id, CultureInfo culture, ISportEventCI requester)
        {
            ...
            var timer = Metric.Context("DataRouterManager")
                .Timer("GetInformationAboutOngoingEventAsync", Unit.Requests);
            using (var t = timer.NewContext($"{id} [{culture.TwoLetterISOLanguageName}]"))
            {
                WriteLog(
                    $"Executing GetInformationAboutOngoingEventAsync for id={id} and culture={culture.TwoLetterISOLanguageName}.",
                    true);
                ...
                catch (Exception e)
                {
                    ...
                    if (e.Message.Contains("NotFound"))
                    {
                        message = message.Contains(".")
                            ...
                            : message;
                        _executionLog.Debug(
                            $"Error getting match timeline for id={id} and lang:[{culture.TwoLetterISOLanguageName}]. Message={message}");
                    }
                    else
                    {
                        _executionLog.Error(
                ...
                if (result != null)
                    await _cacheManager
                        .SaveDtoAsync(result.SportEvent.Id, result, culture, DtoType.MatchTimeline, requester)
                        .ConfigureAwait(false);
                WriteLog(
                    $"Executing GetInformationAboutOngoingEventAsync for id={id} and culture={culture.TwoLetterISOLanguageName} took {restCallTime} ms.{SavingTook(restCallTime, (int) t.Elapsed.TotalMilliseconds)}");
            }
        }
        ...
        public async Task GetMarketDescriptionsAsync(CultureInfo culture)
        {
            ...
            using (var t = timer.NewContext($"[{culture.TwoLetterISOLanguageName}]"))
            {
                ...
                try
                {
                    result = await _invariantMarketDescriptionsProvider.GetDataAsync(culture.TwoLetterISOLanguageName)
                        .ConfigureAwait(false);
                    restCallTime = (int) t.Elapsed.TotalMilliseconds;
                }
                catch (Exception e)
                {
                    ...
                    var message = e.InnerException?.Message ?? e.Message;
                    _executionLog.Error(
                        $"Error getting market descriptions for lang:[{culture.TwoLetterISOLanguageName}]. Message={message}",
                        e.InnerException ?? e);
                    if (ExceptionHandlingStrategy == ExceptionHandlingStrategy.THROW) throw;
                }

                if (result != null)
                    await _cacheManager.SaveDtoAsync(URN.Parse("sr:markets:" + result.Items?.Count()), result, culture,
                        DtoType.MarketDescriptionList, null).ConfigureAwait(false);
                WriteLog(
                    $"Executing GetMarketDescriptionsAsync for culture={culture.TwoLetterISOLanguageName} took {restCallTime} ms.{SavingTook(restCallTime, (int) t.Elapsed.TotalMilliseconds)}");
            }
        }
        ...
        public async Task GetVariantMarketDescriptionAsync(int id, string variant, CultureInfo culture)
        {
            ...
            {
                WriteLog(
                    $"Executing GetVariantMarketDescriptionAsync for id={id}, variant={variant} and culture={culture.TwoLetterISOLanguageName}.",
                    true);
                ...
                try
                {
                    result = await _variantMarketDescriptionProvider
                        .GetDataAsync(id.ToString(), culture.TwoLetterISOLanguageName, variant).ConfigureAwait(false);
                    restCallTime = (int) t.Elapsed.TotalMilliseconds;
                }
                catch (Exception e)
                {
                    ...
                    var message = e.InnerException?.Message ?? e.Message;
                    _executionLog.Error(
                        $"Error getting variant market description for id={id} and lang:[{culture.TwoLetterISOLanguageName}]. Message={message}",
                        e.InnerException ?? e);
                    if (ExceptionHandlingStrategy == ExceptionHandlingStrategy.THROW) throw;
                }

                if (result != null)
                    await _cacheManager.SaveDtoAsync(URN.Parse("sr:variant:" + result.Id), result, culture,
                        DtoType.MarketDescription, null).ConfigureAwait(false);
                WriteLog(
                    $"Executing GetVariantMarketDescriptionAsync for id={id}, variant={variant} and culture={culture.TwoLetterISOLanguageName} took {restCallTime} ms.{SavingTook(restCallTime, (int) t.Elapsed.TotalMilliseconds)}");
            }
        }
        ...
        public async Task GetVariantDescriptionsAsync(CultureInfo culture)
        {
            ...
            using (var t = timer.NewContext($"[{culture.TwoLetterISOLanguageName}]"))
            {
                WriteLog($"Executing GetVariantDescriptionsAsync for culture={culture.TwoLetterISOLanguageName}.",
                    true);
                ...
                try
                {
                    result = await _variantDescriptionsProvider.GetDataAsync(culture.TwoLetterISOLanguageName)
                        .ConfigureAwait(false);
                    restCallTime = (int) t.Elapsed.TotalMilliseconds;
                }
                catch (Exception e)
                {
                    ...
                    var message = e.InnerException?.Message ?? e.Message;
                    _executionLog.Error(
                        $"Error getting variant descriptions for lang:[{culture.TwoLetterISOLanguageName}]. Message={message}",
                        e.InnerException ?? e);
                    if (ExceptionHandlingStrategy == ExceptionHandlingStrategy.THROW) throw;
                }

                if (result != null)
                    await _cacheManager.SaveDtoAsync(URN.Parse("sr:variants:" + result.Items?.Count()), result, culture,
                        DtoType.VariantDescriptionList, null).ConfigureAwait(false);
                WriteLog(
                    $"Executing GetVariantDescriptionsAsync for culture={culture.TwoLetterISOLanguageName} took {restCallTime} ms.{SavingTook(restCallTime, (int) t.Elapsed.TotalMilliseconds)}");
            }
        }
        ...
        public async Task GetDrawSummaryAsync(URN drawId, CultureInfo culture, ISportEventCI requester)
        {
            ...
            {
                WriteLog(
                    $"Executing GetDrawSummaryAsync for id={drawId} and culture={culture.TwoLetterISOLanguageName}.",
                    true);
                ...
                try
                {
                    result = await _lotteryDrawSummaryProvider
                        .GetDataAsync(drawId.ToString(), culture.TwoLetterISOLanguageName).ConfigureAwait(false);
                    restCallTime = (int) t.Elapsed.TotalMilliseconds;
                }
                catch (Exception e)
                {
                    ...
                    var message = e.InnerException?.Message ?? e.Message;
                    _executionLog.Error(
                        $"Error getting draw summary for id={drawId} and lang:[{culture.TwoLetterISOLanguageName}]. Message={message}",
                        e.InnerException ?? e);
                    if (ExceptionHandlingStrategy == ExceptionHandlingStrategy.THROW) throw;
                }

                if (result != null)
                    await _cacheManager.SaveDtoAsync(result.Id, result, culture, DtoType.LotteryDraw, requester)
                        .ConfigureAwait(false);
                WriteLog(
                    $"Executing GetDrawSummaryAsync for id={drawId} and culture={culture.TwoLetterISOLanguageName} took {restCallTime} ms.{SavingTook(restCallTime, (int) t.Elapsed.TotalMilliseconds)}");
            }
        }
        ...
        public async Task GetDrawFixtureAsync(URN drawId, CultureInfo culture, ISportEventCI requester)
        {
            ...
            {
                WriteLog(
                    $"Executing GetDrawFixtureAsync for id={drawId} and culture={culture.TwoLetterISOLanguageName}.",
                    true);
                ...
                try
                {
                    result = await _lotteryDrawFixtureProvider
                        .GetDataAsync(drawId.ToString(), culture.TwoLetterISOLanguageName).ConfigureAwait(false);
                    restCallTime = (int) t.Elapsed.TotalMilliseconds;
                }
                catch (Exception e)
                {
                    ...
                    var message = e.InnerException?.Message ?? e.Message;
                    _executionLog.Error(
                        $"Error getting draw fixture for id={drawId} and lang:[{culture.TwoLetterISOLanguageName}]. Message={message}",
                        e.InnerException ?? e);
                    if (ExceptionHandlingStrategy == ExceptionHandlingStrategy.THROW) throw;
                }
                ...
                if (result != null)
                    await _cacheManager.SaveDtoAsync(result.Id, result, culture, DtoType.LotteryDraw, requester)
                        .ConfigureAwait(false);
                WriteLog(
                    $"Executing GetDrawFixtureAsync for id={drawId} and culture={culture.TwoLetterISOLanguageName} took {restCallTime} ms.{SavingTook(restCallTime, (int) t.Elapsed.TotalMilliseconds)}");
            }
        }
        ...
        public async Task GetLotteryScheduleAsync(URN lotteryId, CultureInfo culture, ISportEventCI requester)
        {
            ...
            {
                WriteLog(
                    $"Executing GetLotteryScheduleAsync for id={lotteryId} and culture={culture.TwoLetterISOLanguageName}.",
                    true);
                ...
                try
                {
                    result = await _lotteryScheduleProvider
                        .GetDataAsync(lotteryId.ToString(), culture.TwoLetterISOLanguageName).ConfigureAwait(false);
                    restCallTime = (int) t.Elapsed.TotalMilliseconds;
                }
                catch (Exception e)
                {
                    ...
                    var message = e.InnerException?.Message ?? e.Message;
                    _executionLog.Error(
                        $"Error getting lottery schedule for id={lotteryId} and lang:[{culture.TwoLetterISOLanguageName}]. Message={message}",
                        e.InnerException ?? e);
                    if (ExceptionHandlingStrategy == ExceptionHandlingStrategy.THROW) throw;
                }

                if (result != null)
                    await _cacheManager.SaveDtoAsync(result.Id, result, culture, DtoType.Lottery, null)
                        .ConfigureAwait(false);
                WriteLog(
                    $"Executing GetLotteryScheduleAsync for id={lotteryId} and culture={culture.TwoLetterISOLanguageName} took {restCallTime} ms.{SavingTook(restCallTime, (int) t.Elapsed.TotalMilliseconds)}");
            }
        }
        ...
        public async Task<IEnumerable<URN>> GetAllLotteriesAsync(CultureInfo culture)
        {
            ...
            using (var t = timer.NewContext($"[{culture.TwoLetterISOLanguageName}]"))
            {
                ...
                try
                {
                    result = await _lotteryListProvider.GetDataAsync(culture.TwoLetterISOLanguageName)
                        .ConfigureAwait(false);
                    restCallTime = (int) t.Elapsed.TotalMilliseconds;
                }
                catch (Exception e)
                {
                    ...
                    var message = e.InnerException?.Message ?? e.Message;
                    _executionLog.Error(
                        $"Error getting all lotteries for lang:[{culture.TwoLetterISOLanguageName}]. Message={message}",
                        e.InnerException ?? e);
                    if (ExceptionHandlingStrategy == ExceptionHandlingStrategy.THROW) throw;
                }
                ...
                {
                    await _cacheManager.SaveDtoAsync(URN.Parse($"sr:lotteries:{result.Items.Count()}"), result, culture,
                        DtoType.LotteryList, null).ConfigureAwait(false);
                    var urns = new List<URN>();
                    foreach (var item in result.Items) urns.Add(item.Id);
                    WriteLog(
                        $"Executing GetAllLotteriesAsync for tournament culture={culture.TwoLetterISOLanguageName} took {restCallTime} ms.{SavingTook(restCallTime, (int) t.Elapsed.TotalMilliseconds)}");
                    return urns;
                }

                WriteLog(
                    $"Executing GetAllLotteriesAsync for culture={culture.TwoLetterISOLanguageName} took {restCallTime} ms. {SavingTook(restCallTime, (int) t.Elapsed.TotalMilliseconds)} No data.");
            }
        ...
        public async Task<IAvailableSelections> GetAvailableSelectionsAsync(URN id)
        {
            ...
            using (var t = timer.NewContext($"{id}"))
            {
                ...
                catch (Exception e)
                {
                    restCallTime = (int) t.Elapsed.TotalMilliseconds;
                    var message = e.InnerException?.Message ?? e.Message;
                    _executionLog.Error($"Error getting available selections for id={id}. Message={message}",
                        e.InnerException ?? e);
                    if (ExceptionHandlingStrategy == ExceptionHandlingStrategy.THROW) throw;
                }

                if (result != null)
                    await _cacheManager.SaveDtoAsync(id, result, _defaultLocale, DtoType.AvailableSelections, null)
                        .ConfigureAwait(false);
                WriteLog(
                    $"Executing GetAvailableSelectionsAsync for id={id} took {restCallTime} ms.{SavingTook(restCallTime, (int) t.Elapsed.TotalMilliseconds)}");
        ...
        public async Task<ICalculation> CalculateProbability(IEnumerable<ISelection> selections)
        {
            ...
            using (var t = timer.NewContext())
            {
                ...
                WriteLog(
                    $"Executing CalculateProbability took {restCallTime} ms.{SavingTook(restCallTime, (int) t.Elapsed.TotalMilliseconds)}");
        ...
        public async Task<IEnumerable<IFixtureChange>> GetFixtureChangesAsync(CultureInfo culture)
        {
            ...
            using (var t = timer.NewContext())
            {
                ...
                try
                {
                    result = await _fixtureChangesProvider.GetDataAsync(culture.TwoLetterISOLanguageName)
                        .ConfigureAwait(false);
                    restCallTime = (int) t.Elapsed.TotalMilliseconds;
                }
                catch (Exception e)
                ...
                WriteLog(
                    $"Executing GetFixtureChangesAsync took {restCallTime} ms.{SavingTook(restCallTime, (int) t.Elapsed.TotalMilliseconds)}");
        ...
        private static string SavingTook(int restTime, int totalTime)
        {
            ...
            if (difference > 10) return $" Saving took {difference} ms.";
            return string.Empty;
        }
    }
}