...
{
    /// <summary>
    ///     An implementation of the <see cref="IDataProvider{T}" /> which fetches the data, deserializes it and than maps /
    ///     converts it
    ///     to the output type
    /// </summary>
    ...
    public class DataProvider<TIn, TOut> : IDataProvider<TOut> where TIn : RestMessage where TOut : class
    {
        ...
        ///     A <see cref="ISingleTypeMapperFactory{T, T1}" /> used to construct instances of
        ///     <see cref="ISingleTypeMapper{T}" />
        /// </param>
        public DataProvider(string uriFormat, IDataFetcher fetcher, IDeserializer<TIn> deserializer,
            ISingleTypeMapperFactory<TIn, TOut> mapperFactory)
        {
        ...
        /// <exception cref="Sportradar.OddsFeed.SDK.Common.Exceptions.MappingException">
        ///     The deserialized entity could not be
        ///     mapped to entity used by the SDK
        /// </exception>
        ...
        /// <summary>
        ///     Gets a <see cref="!:T" /> instance specified by the provided identifiersA two letter language code of the
