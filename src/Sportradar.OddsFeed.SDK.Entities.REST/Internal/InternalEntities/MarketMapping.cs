...
namespace Sportradar.OddsFeed.SDK.Entities.REST.Internal.InternalEntities
{
    internal class MarketMapping : IMarketMappingData
    {
        ...
        /// <summary>
        ///     Determines whether the current mapping can map market with provided specifiers associated with provided producer
        ///     and sport
        /// </summary>
        ...
        {
            if (!ProducerIds.Contains(producer.Id) || !SportId.Equals(sportId)) return false;
