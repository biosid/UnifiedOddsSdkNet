...
namespace Sportradar.OddsFeed.SDK.Entities.REST.Internal
{
    ...
    public interface ISportEntityFactory
    {
        ...
        ///     A <see cref="ExceptionHandlingStrategy" /> enum member specifying how the build
        ///     instance will handle potential exceptions
        /// </param>
        /// <returns>A <see cref="Task{T}" /> representing the asynchronous operation</returns>
        Task<IEnumerable<ISport>> BuildSportsAsync(IEnumerable<CultureInfo> cultures,
        ...
        /// </summary>
        /// <param name="id">
        ///     A <see cref="URN" /> specifying the id of the sport which will be represented by the constructed
        ///     instance
        /// </param>
        /// <param name="cultures">A list of all supported languages</param>
        /// <param name="exceptionStrategy">
        ...
        Task<ISport> BuildSportAsync(URN id, IEnumerable<CultureInfo> cultures,
            ExceptionHandlingStrategy exceptionStrategy);

        /// <summary>
        ///     Builds and returns a new instance of the <see cref="IPlayer" /> representing the player or competitor profile
        ///     specified by its id
        /// </summary>
        /// <param name="id">
        ///     A <see cref="URN" /> specifying the id of the player or competitor which will be represented by the
        ...
        /// <summary>
        ///     Builds and returns a new instance of the <see cref="IPlayer" /> representing the player and/or competitor profiles
        ///     specified by ids
        /// </summary>
        /// <param name="ids">
        ///     A list of <see cref="URN" /> specifying the ids of the players or competitors which will be
        ///     represented by the constructed instances
        /// </param>
        /// <param name="cultures">A list of all supported languages</param>
        /// <returns>A <see cref="Task{T}" /> representing the asynchronous operation</returns>
        ...
        T BuildSportEvent<T>(URN id, URN sportId, IEnumerable<CultureInfo> cultures,
            ExceptionHandlingStrategy exceptionStrategy) where T : ISportEvent;
        ...
        ICompetitor BuildCompetitor(CompetitorCI ci, IEnumerable<CultureInfo> cultures,
        ...
        ITeamCompetitor BuildTeamCompetitor(TeamCompetitorCI ci, IEnumerable<CultureInfo> culture,
            ICompetitionCI rootCompetitionCI);
        ...
        /// <param name="rootCompetitionCI">A root <see cref="CompetitionCI" /> to which this competitor belongs to</param>
        /// <returns>The constructed <see cref="ICompetitor" /> instance</returns>
        Task<ICompetitor> BuildCompetitorAsync(URN competitorId, IEnumerable<CultureInfo> cultures,
            ICompetitionCI rootCompetitionCI);
        ...
        /// <param name="rootCompetitionCI">A root <see cref="CompetitionCI" /> to which this competitor belongs to</param>
        /// <returns>The constructed <see cref="ITeamCompetitor" /> instance</returns>
        Task<ITeamCompetitor> BuildTeamCompetitorAsync(URN teamCompetitorId, IEnumerable<CultureInfo> culture,
            ICompetitionCI rootCompetitionCI);
    }
}