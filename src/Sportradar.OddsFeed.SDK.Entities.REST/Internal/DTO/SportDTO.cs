...
namespace Sportradar.OddsFeed.SDK.Entities.REST.Internal.DTO
{
    ...
    {
        /// <summary>
        ///     A <see cref="IEqualityComparer{T}" /> used to compare different <see cref="tournamentExtended" /> instances
        /// </summary>
        private static readonly IEqualityComparer<tournamentExtended> EqualityComparer =
            new TournamentByCategoryIdEqualityComparer();
        ...
        ///     A <see cref="IEnumerable{tournamentExtended}" /> representing tournament which belong to the
        ///     sport
        /// </param>
        ...
        /// <summary>
        ///     A <see cref="IEqualityComparer{tournamentExtended}" /> used for equality comparison of
        ///     <see cref="tournamentExtended" /> instances. Instances are
