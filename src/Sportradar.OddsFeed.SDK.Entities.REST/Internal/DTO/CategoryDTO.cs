...
namespace Sportradar.OddsFeed.SDK.Entities.REST.Internal.DTO
{
    ...
    public class CategoryDTO : CategorySummaryDTO
    {
        ...
        private static readonly IEqualityComparer<tournamentExtended> EqualityComparer =
            new TournamentByTournamentIdEqualityComparer();
        ...
        /// <summary>
        ///     A <see cref="IEqualityComparer{tournamentExtended}" /> implementation used for equality comparison of
        ///     <see cref="tournamentExtended" /> instances
        /// </summary>
