...
namespace Sportradar.OddsFeed.SDK.Entities.REST.Internal.DTO
{
    ...
    public class StageDTO : CompetitionDTO
    {
        ...
        internal StageDTO(sportEvent sportEvent)
            : base(sportEvent)
        {
            if (sportEvent.parent != null) ParentStage = new StageDTO(sportEvent.parent);
        ...
        internal StageDTO(stageSummaryEndpoint stageEvent)
            : base(stageEvent)
        {
            if (stageEvent.sport_event.parent != null) ParentStage = new StageDTO(stageEvent.sport_event.parent);
