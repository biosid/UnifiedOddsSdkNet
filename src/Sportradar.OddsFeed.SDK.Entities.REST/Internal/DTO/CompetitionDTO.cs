...
namespace Sportradar.OddsFeed.SDK.Entities.REST.Internal.DTO
{
    ...
    public class CompetitionDTO : SportEventSummaryDTO
    {
            ...
            : base(sportEvent)
        {
            ...
            {
                Competitors =
                    new ReadOnlyCollection<TeamCompetitorDTO>(sportEvent.competitors
                        .Select(c => new TeamCompetitorDTO(c)).ToList());
            ...
            if (Venue == null && sportEvent.venue != null) Venue = new VenueDTO(sportEvent.venue);
        }
        ...
        ///     A <see cref="matchSummaryEndpoint" /> instance containing basic information about the sport
        ///     event
        /// </param>
            ...
            : this(matchSummary.sport_event)
        {
            ...
            Status = matchSummary.sport_event_status == null
                ? null
                : new SportEventStatusDTO(matchSummary.sport_event_status, matchSummary.statistics,
                    HomeAwayCompetitors);
            ...
            if (Venue == null && matchSummary.venue != null) Venue = new VenueDTO(matchSummary.venue);
        }
        ...
        ///     A <see cref="stageSummaryEndpoint" /> instance containing basic information about the sport
        ///     event
        /// </param>
