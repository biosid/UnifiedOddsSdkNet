...
namespace Sportradar.OddsFeed.SDK.Entities.REST.Internal.DTO
{
    ...
    public class CurrentSeasonInfoDTO : SportEntityDTO
    {
            ...
            : base(season.id, season.name)
        {
            ...
            if (season.end_timeSpecified) EndDate = SdkInfo.CombineDateAndTime(season.end_date, season.end_time);
        }
        ...
        /// <summary>
        ///     Gets the <see cref="SeasonCoverageDTO" /> instance containing information about coverage available for the season
        ///     associated with the current instance
        /// </summary>
        /// <returns>
        ///     The <see cref="SeasonCoverageDTO" /> instance containing information about coverage available for the season
        ///     associated with the current instance
        /// </returns>
        ...
        /// <summary>
        ///     Gets the <see cref="RoundDTO" /> specifying the current round of the tournament associated with the current
        ///     instance
        /// </summary>
        /// <returns>
        ///     The <see cref="RoundDTO" /> specifying the current round of the tournament associated with the current
        ///     instance
        /// </returns>
