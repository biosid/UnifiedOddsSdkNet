    ...
    public class TournamentDTO : SportEntityDTO
    {
            ...
            : base(tournament.id, tournament.name)
        {
            ...
            Category = tournament.category == null && tournament.id.StartsWith("vf")
                ? CreateFakeCategory()
                : new CategorySummaryDTO(tournament.category?.id, tournament.category?.name,
        ...
        /// <summary>
        ///     Gets a <see cref="DateTime" /> indicating when the tournament is scheduled to start, or a null reference if value
        ///     is not known.
        /// </summary>
        public DateTime? Scheduled { get; }

        /// <summary>
        ///     Gets a <see cref="DateTime" /> indicating when the tournament is scheduled to end, or a null reference if value is
        ///     not known.
        /// </summary>
