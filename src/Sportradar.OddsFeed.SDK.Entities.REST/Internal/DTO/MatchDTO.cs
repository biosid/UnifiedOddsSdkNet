...
namespace Sportradar.OddsFeed.SDK.Entities.REST.Internal.DTO
{
    ...
    public class MatchDTO : CompetitionDTO
    {
            ...
            : base(sportEvent)
        {
            ...
            if (sportEvent.tournament_round != null) Round = new RoundDTO(sportEvent.tournament_round);
        ...
        /// <summary>
        ///     Gets a <see cref="SportEntityDTO" /> instance specifying the season to which the sport event associated with the
        ///     current instance belongs to.
        /// </summary>
