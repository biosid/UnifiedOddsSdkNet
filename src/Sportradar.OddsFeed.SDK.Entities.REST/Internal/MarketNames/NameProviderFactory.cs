...
namespace Sportradar.OddsFeed.SDK.Entities.REST.Internal.MarketNames
{
    ...
    internal class NameProviderFactory : INameProviderFactory
    {
        ...
        /// </param>
        public NameProviderFactory(IMarketCacheProvider marketCacheProvider, IProfileCache profileCache,
            INameExpressionFactory expressionFactory, ExceptionHandlingStrategy exceptionStrategy)
        {
        ...
        public INameProvider BuildNameProvider(ISportEvent sportEvent, int marketId,
            IReadOnlyDictionary<string, string> specifiers)
        {
            return new NameProvider(_marketCacheProvider, _profileCache, _expressionFactory, sportEvent, marketId,
                specifiers, _exceptionStrategy);
        }
