...
{
    /// <summary>
    ///     Defines a contract implemented by classes used to build <see cref="INameExpression" /> instances from string
    ///     expressions
    /// </summary>
    public interface INameExpressionFactory
    {
        ...
        INameExpression BuildExpression(ISportEvent sportEvent, IReadOnlyDictionary<string, string> specifiers,
