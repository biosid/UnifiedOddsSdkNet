...
namespace Sportradar.OddsFeed.SDK.Entities.REST.Internal.MarketNames
{
    ...
    internal class MarketMappingProviderFactory : IMarketMappingProviderFactory
    {
        ...
        ///     A <see cref="ExceptionHandlingStrategy" /> specifying how to handle potential
        ///     exceptions thrown to the user code
        /// </param>
        /// <param name="producerManager">An <see cref="IProducerManager" /> used to get <see cref="IProducer" /></param>
        public MarketMappingProviderFactory(IMarketCacheProvider marketCacheProvider,
            ISportEventStatusCache eventStatusCache, ExceptionHandlingStrategy exceptionStrategy,
        ...
        public IMarketMappingProvider BuildMarketMappingProvider(ISportEvent sportEvent, int marketId,
            IReadOnlyDictionary<string, string> specifiers, IProducer producer, URN sportId)
        {
            return new MarketMappingProvider(_marketCacheProvider, _eventStatusCache, sportEvent, marketId, specifiers,
                producer, sportId, _exceptionStrategy, _producerManager);
        }
