...
namespace Sportradar.OddsFeed.SDK.Entities.REST.Internal.EntitiesImpl
{
    ...
    internal class EventClock : EntityPrinter, IEventClock
    {
        ...
        ///     the event time of the sport event associated with the current <see cref="IEventClock" />
        ///     instance
        /// </param>
        /// <param name="stoppageTime">
        ///     the <see cref="string" /> representation of the stoppage time the event associated with the
        ///     current
        /// </param>
        ...
        public EventClock(string eventTime, string stoppageTime, string stoppageTimeAnnounced, string remainingDate,
            string remainingTimeInPeriod, bool? stopped)
        {
        ...
        {
            return
                $"EventTime={_eventTime}, StoppageTime={_stoppageTime}, StoppageTimeAnnounced={_stoppageTimeAnnounced}, RemainingDate={RemainingDate}, RemainingTimeInPeriod={RemainingTimeInPeriod}, Stopped={Stopped}";
        }
