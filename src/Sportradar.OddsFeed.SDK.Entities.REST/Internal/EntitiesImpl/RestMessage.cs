...
namespace Sportradar.OddsFeed.SDK.Entities.REST.Internal.EntitiesImpl
{
    ...
    internal abstract class RestMessage : IRestMessage
    {
        ...
        ///     a <see cref="DateTime" /> instance specifying when the message represented by the current
        ///     <see cref="IRestMessage" /> was generated
        /// </param>
        ...
        /// <summary>
        ///     Gets a <see cref="DateTime" /> instance specifying when the message represented by the current
        ///     <see cref="IRestMessage" />
