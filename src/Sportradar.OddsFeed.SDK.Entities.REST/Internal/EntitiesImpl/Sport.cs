...
namespace Sportradar.OddsFeed.SDK.Entities.REST.Internal.EntitiesImpl
{
    ...
    internal class Sport : SportSummary, ISport
    {
        ...
        /// <param name="names">a <see cref="IReadOnlyDictionary{TKey,TValue}" /> containing translated sport names</param>
        /// <param name="categories">
        ///     a <see cref="IEnumerable{ICategory}" /> representing categories
            ...
            : base(id, names)
        {
            ...
            if (categories != null)
                Categories = categories as IReadOnlyCollection<ICategory> ??
                             new ReadOnlyCollection<ICategory>(categories.ToList());
        }
        ...
        protected override string PrintC()
        {
            ...
            var cats = Categories == null
                ? string.Empty
                : string.Join(", ", Categories.Select(k => ((Category) k).ToString()));
        ...
        protected override string PrintF()
        {
            ...
            var cats = Categories == null
                ? string.Empty
                : string.Join("; ", Categories.Select(k => ((Category) k).ToString("f")));
