...
namespace Sportradar.OddsFeed.SDK.Entities.REST.Internal.EntitiesImpl
{
    ...
    internal class SportEventConditions : EntityPrinter, ISportEventConditionsV1
    {
        ...
        public SportEventConditions(SportEventConditionsCI ci, IEnumerable<CultureInfo> cultures)
        {
            ...
            if (ci.Referee != null) Referee = new Referee(ci.Referee, cultures);
            if (ci.WeatherInfo != null) WeatherInfo = new WeatherInfo(ci.WeatherInfo);

            if (ci.Pitchers != null) Pitchers = ci.Pitchers.Select(s => new Pitcher(s));
        }
        ...
        protected override string PrintC()
        {
            ...
            return
                $"Attendance={Attendance}, EventMode={EventMode}, Referee={refereeStr}, WeatherInfo={weatherStr}, Pitchers=[{pitcherStr}]";
        }
