...
namespace Sportradar.OddsFeed.SDK.Entities.REST.Internal.EntitiesImpl
{
    ...
    internal class PeriodScore : EntityPrinter, IPeriodScore
    {
        ...
        {
            return MatchStatusCode == null || _matchStatusesCache == null
                ? null
                : await _matchStatusesCache.GetAsync(MatchStatusCode.Value, new List<CultureInfo> {culture})
        ...
        {
            return
                $"HomeScore={_homeScore}, AwayScore={_awayScore}, Type={_type}, Number={_number}, MatchStatusCode={MatchStatusCode}";
        }
