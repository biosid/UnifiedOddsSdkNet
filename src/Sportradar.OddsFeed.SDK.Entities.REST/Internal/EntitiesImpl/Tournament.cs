...
namespace Sportradar.OddsFeed.SDK.Entities.REST.Internal.EntitiesImpl
{
    ...
    internal class Tournament : SportEvent, ITournament
    {
        ...
        ///     A <see cref="ISportEntityFactory" /> used to construct <see cref="ISportEvent" />
        /// </param>
        ...
        public async Task<ITournamentCoverage> GetTournamentCoverage()
        {
            ...
            var tournamentCoverageCI = ExceptionStrategy == ExceptionHandlingStrategy.THROW
                ...
                : await new Func<Task<TournamentCoverageCI>>(tournamentInfoCI.GetTournamentCoverageAsync)
        ...
        public async Task<ICategorySummary> GetCategoryAsync()
        {
            ...
            var categoryId = ExceptionStrategy == ExceptionHandlingStrategy.THROW
                ...
                : await new Func<Task<URN>>(tournamentInfoCI.GetCategoryIdAsync)
                    .SafeInvokeAsync(ExecutionLog, GetFetchErrorMessage("CategoryId")).ConfigureAwait(false);
            if (categoryId == null)
            {
            ...
            var categoryData = ExceptionStrategy == ExceptionHandlingStrategy.THROW
                ...
                : await new Func<URN, IEnumerable<CultureInfo>, Task<CategoryData>>(_sportDataCache.GetCategoryAsync)
                    .SafeInvokeAsync(categoryId, Cultures, ExecutionLog, GetFetchErrorMessage("CategoryData"))
                    .ConfigureAwait(false);
        ...
        public async Task<ICurrentSeasonInfo> GetCurrentSeasonAsync()
        {
            ...
            if (currentSeasonInfoCI == null) return null;
        ...
        public async Task<IEnumerable<ISeason>> GetSeasonsAsync()
        {
            ...
            var seasonIds = ExceptionStrategy == ExceptionHandlingStrategy.THROW
                ...
                : await new Func<IEnumerable<CultureInfo>, Task<IEnumerable<URN>>>(tournamentInfoCI.GetSeasonsAsync)
                    .SafeInvokeAsync(Cultures, ExecutionLog, GetFetchErrorMessage("Seasons")).ConfigureAwait(false);

            return seasonIds?.Select(s =>
                _sportEntityFactory.BuildSportEvent<ISeason>(s, SportId, Cultures, ExceptionStrategy));
        }
    }
}