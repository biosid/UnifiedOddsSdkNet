...
namespace Sportradar.OddsFeed.SDK.Entities.REST.Internal.EntitiesImpl
{
    ...
    internal class Venue : EntityPrinter, IVenue
    {
        ...
        /// <summary>
        ///     Gets a map coordinates specifying the exact location of the venue represented by current <see cref="IVenue" />
        ///     instance
        /// </summary>
        ...
        /// <summary>
        ///     Gets a <see cref="IReadOnlyDictionary{CultureInfo, String}" /> containing venue's country names in different
        ///     languages
        /// </summary>
        ...
        protected override string PrintF()
        {
            ...
            return
                $"Id={Id}, Capacity={Capacity}, Coordinates={Coordinates}, Names=[{names}], Cities=[{cityNames}], Countries=[{countryNames}], CountryCode={CountryCode}";
        }
