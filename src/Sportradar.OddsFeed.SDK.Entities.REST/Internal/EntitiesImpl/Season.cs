...
namespace Sportradar.OddsFeed.SDK.Entities.REST.Internal.EntitiesImpl
{
    ...
    internal class Season : SportEvent, ISeason
    {
        ...
        /// <summary>
        ///     A <see cref="ISportDataCache" /> instance used to retrieve basic information about the tournament(sport, category,
        ///     names)
        /// </summary>
        ...
        ///     The <see cref="ExceptionHandlingStrategy" /> indicating how to handle potential
        ...
        public async Task<ISportSummary> GetSportAsync()
        {
            ...
            var sportId = ExceptionStrategy == ExceptionHandlingStrategy.THROW
                ...
                : await new Func<Task<URN>>(seasonCI.GetSportIdAsync)
        ...
        /// <summary>
        ///     Asynchronously get the <see cref="ITournamentCoverage" /> instance representing the tournament coverage associated
        ///     with the current instance
        /// </summary>
        /// <returns>Task&lt;ITournamentCoverage&gt;.</returns>
        /// <value>
        ///     The <see cref="ITournamentCoverage" /> instance representing the tournament coverage associated with the current
        ///     instance
        /// </value>
        public async Task<ITournamentCoverage> GetTournamentCoverage()
        {
            ...
            var tournamentCoverageCI = ExceptionStrategy == ExceptionHandlingStrategy.THROW
                ...
                : await new Func<Task<TournamentCoverageCI>>(seasonCI.GetTournamentCoverageAsync)
                    .SafeInvokeAsync(ExecutionLog, GetFetchErrorMessage("TournamentCoverage")).ConfigureAwait(false);
        ...
        public async Task<ISeasonCoverage> GetSeasonCoverageAsync()
        {
            ...
            var seasonCoverageCI = ExceptionStrategy == ExceptionHandlingStrategy.THROW
                ...
                : await new Func<Task<SeasonCoverageCI>>(seasonCI.GetSeasonCoverageAsync)
                    .SafeInvokeAsync(ExecutionLog, GetFetchErrorMessage("SeasonCoverage")).ConfigureAwait(false);
        ...
        /// <summary>
        ///     Asynchronously gets a <see cref="IEnumerable{IGroup}" /> specifying groups of tournament associated with the
        ///     current instance
        /// </summary>
        ...
        public async Task<IEnumerable<IGroup>> GetGroupsAsync()
        {
            ...
            var groupsCI = ExceptionStrategy == ExceptionHandlingStrategy.THROW
                ...
                : await new Func<IEnumerable<CultureInfo>, Task<IEnumerable<GroupCI>>>(seasonCI.GetGroupsAsync)
                    .SafeInvokeAsync(Cultures, ExecutionLog, GetFetchErrorMessage("Groups")).ConfigureAwait(false);
            ...
            return groupCis == null || !groupCis.Any()
                ? null
                : new List<IGroup>(groupCis.Select(g =>
                    new Group(g, Cultures, _sportEntityFactory, competitorsReferences)));
        }
        ...
        public async Task<IRound> GetCurrentRoundAsync()
        {
            ...
            var currentRoundCI = ExceptionStrategy == ExceptionHandlingStrategy.THROW
                ...
                : await new Func<IEnumerable<CultureInfo>, Task<RoundCI>>(seasonCI.GetCurrentRoundAsync)
                    .SafeInvokeAsync(Cultures, ExecutionLog, GetFetchErrorMessage("CurrentRound"))
                    .ConfigureAwait(false);
        ...
        public async Task<string> GetYearAsync()
        {
            ...
            var year = ExceptionStrategy == ExceptionHandlingStrategy.THROW
                ...
                : await new Func<Task<string>>(seasonCI.GetYearAsync)
                    .SafeInvokeAsync(ExecutionLog, GetFetchErrorMessage("Year")).ConfigureAwait(false);
        ...
        public async Task<ITournamentInfo> GetTournamentInfoAsync()
        {
            ...
            if (currentSeasonCI == null) return new TournamentInfo(tournamentInfoBasicCI, categorySummary, null);
        ...
        public async Task<IEnumerable<ICompetitor>> GetCompetitorsAsync()
        {
            ...
            var item = ExceptionStrategy == ExceptionHandlingStrategy.THROW
                ...
                : await new Func<IEnumerable<CultureInfo>, Task<IEnumerable<CompetitorCI>>>(
                        seasonCI.GetCompetitorsAsync)
                    .SafeInvokeAsync(Cultures, ExecutionLog, GetFetchErrorMessage("Competitors")).ConfigureAwait(false);
        ...
        public async Task<IEnumerable<ICompetition>> GetScheduleAsync()
        {
            var sportEventIds = ExceptionStrategy == ExceptionHandlingStrategy.THROW
                ...
                : await new Func<URN, Task<IEnumerable<Tuple<URN, URN>>>>(_sportEventCache.GetEventIdsAsync)
                    .SafeInvokeAsync(Id, ExecutionLog, GetFetchErrorMessage("Schedule")).ConfigureAwait(false);

            return sportEventIds?.Select(i =>
                    _sportEntityFactory.BuildSportEvent<ICompetition>(i.Item1, i.Item2, Cultures, ExceptionStrategy))
                .ToList();
        }
