...
namespace Sportradar.OddsFeed.SDK.Entities.REST.Internal.EntitiesImpl
{
    ...
    internal class CoverageInfo : EntityPrinter, ICoverageInfoV1
    {
        ...
        /// <param name="isLive">
        ///     a value indicating whether the coverage represented by current <see cref="ICoverageInfo" /> is
        ///     live coverage
        /// </param>
        /// <param name="includes">
        ///     a <see cref="IEnumerable{String}" /> specifying what is included in the coverage represented by the
        ...
        public CoverageInfo(string level, bool isLive, IEnumerable<string> includes, CoveredFrom? coveredFrom)
        {
            ...
            _isLive = isLive;
            if (includes != null)
                _includes = includes as IReadOnlyCollection<string> ??
                            new ReadOnlyCollection<string>(includes.ToList());
