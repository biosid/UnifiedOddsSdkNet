...
namespace Sportradar.OddsFeed.SDK.Entities.REST.Internal
{
    ...
    public class NamedValueDataProvider : IDataProvider<EntityList<NamedValueDTO>>
    {
        ...
        /// <summary>
        ///     Asynchronously gets a <see cref="!:T" /> instance specified by the provided identifiersA two letter language code
        ///     of the <see cref="T:System.Globalization.CultureInfo" />
        /// </summary>
