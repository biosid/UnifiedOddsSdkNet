...
namespace Sportradar.OddsFeed.SDK.Entities.REST.Internal.Caching.Events
{
    ...
    public interface ICompetitionCI : ISportEventCI
    {
        ...
        /// <summary>
        ///     Asynchronously gets a <see cref="VenueCI" /> instance representing a venue where the sport event associated with
        ///     the
        ...
        /// <summary>
        ///     Asynchronously gets a <see cref="SportEventConditionsCI" /> instance representing live conditions of the sport
        ///     event associated with the current instance
        /// </summary>
        /// <param name="cultures">
        ///     A <see cref="IEnumerable{CultureInfo}" /> specifying the languages to which the returned
        ///     instance should be translated
        ...
        /// <summary>
        ///     Asynchronously gets a <see cref="IEnumerable{URN}" /> providing information about competitors competing in a sport
        ///     event
