...
namespace Sportradar.OddsFeed.SDK.Entities.REST.Internal.Caching.Events
{
    ...
    public class SportEventStatusCI : ISportEventStatusCI
    {
        ...
        {
            if (feedStatusDTO == null && sapiStatusDTO == null) throw new ArgumentNullException(nameof(feedStatusDTO));
        ...
        public ReportingStatus ReportingStatus =>
            FeedStatusDTO?.ReportingStatus ?? SapiStatusDTO?.ReportingStatus ?? ReportingStatus.Unknown;
        ...
        public SportEventStatisticsDTO SportEventStatistics =>
        ...
        public IDictionary<HomeAway, URN> HomeAwayCompetitors =>
            FeedStatusDTO?._homeAwayCompetitors ?? SapiStatusDTO?._homeAwayCompetitors;
        ...
        {
            if (feedDTO != null) FeedStatusDTO = feedDTO;
        }
        ...
        {
            if (sapiDTO != null) SapiStatusDTO = sapiDTO;
        }
    }
}