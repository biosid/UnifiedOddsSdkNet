...
namespace Sportradar.OddsFeed.SDK.Entities.REST.Internal.Caching.Events
{
    ...
    public class CompetitionCI : SportEventCI, ICompetitionCI
    {
        ...
        /// <summary>
        ///     Asynchronously fetch event summary associated with the current instance (saving done in
        ///     <see cref="ISportEventStatusCache" />)
        /// </summary>
        ...
        /// <summary>
        ///     Asynchronously gets a <see cref="BookingStatus" /> enum member providing booking status for the associated entity
        ///     or a null reference if booking status is not known
        /// </summary>
        ...
        public async Task<VenueCI> GetVenueAsync(IEnumerable<CultureInfo> cultures)
        {
            ...
            if (_venue != null && _venue.HasTranslationsFor(cultureInfos)) return _venue;
        ...
        public async Task<IEnumerable<URN>> GetCompetitorsAsync(IEnumerable<CultureInfo> cultures)
        {
            ...
            if (Competitors != null && Competitors.Any() && HasTranslationsFor(cultureInfos)) return Competitors;
            await FetchMissingSummary(cultureInfos, false).ConfigureAwait(false);
            return Competitors;
        }
        ...
        {
            if (!LoadedFixtures.Any()) await FetchMissingFixtures(new[] {DefaultCulture}).ConfigureAwait(false);
        ...
        {
            if (!LoadedSummaries.Any()) await FetchMissingSummary(new[] {DefaultCulture}, false).ConfigureAwait(false);
        ...
        public void MergeFixture(FixtureDTO fixture, CultureInfo culture, bool useLock)
        {
            ...
            if (useLock)
            {
                lock (MergeLock)
                {
                    ...
                    if (fixture.BookingStatus != null) _bookingStatus = fixture.BookingStatus;
                }
            }
            else
            {
        ...
        private void ActualMerge(CompetitionDTO eventSummary, CultureInfo culture)
        {
            ...
            if (eventSummary.BookingStatus != null) _bookingStatus = eventSummary.BookingStatus;
        }
        ...
        private void GenerateMatchName(IEnumerable<TeamCompetitorDTO> competitors, CultureInfo culture)
        {
            ...
            {
                string name;
                if (Names.TryGetValue(culture, out name) && !string.IsNullOrEmpty(name)) return;
        ...
        private void FillCompetitorsQualifiers(IEnumerable<TeamCompetitorDTO> competitors)
        {
            ...
            if (_competitorsQualifiers == null) _competitorsQualifiers = new Dictionary<URN, string>();
