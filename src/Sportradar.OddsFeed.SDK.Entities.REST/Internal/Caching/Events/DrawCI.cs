...
namespace Sportradar.OddsFeed.SDK.Entities.REST.Internal.Caching.Events
{
    ...
    internal class DrawCI : SportEventCI, IDrawCI
    {
        ...
        {
            if (LoadedSummaries.Any()) return _lotteryId;
        ...
        {
            if (LoadedSummaries.Any()) return _drawStatus;
            await FetchMissingSummary(new[] {DefaultCulture}, false).ConfigureAwait(false);
            return _drawStatus;
        }
        ...
        {
            if (LoadedSummaries.Any()) return _resultsChronological;
            await FetchMissingSummary(new[] {DefaultCulture}, false).ConfigureAwait(false);
        ...
        {
            if (LoadedSummaries.Any()) return _displayId;
            await FetchMissingSummary(new[] {DefaultCulture}, false).ConfigureAwait(false);
            return _displayId;
        }
        ...
        private void ActualMerge(DrawDTO eventSummary, CultureInfo culture)
        {
            ...
            if (eventSummary.Lottery != null) _lotteryId = eventSummary.Lottery.Id;
            ...
            if (eventSummary.DisplayId != null) _displayId = eventSummary.DisplayId;
        }
