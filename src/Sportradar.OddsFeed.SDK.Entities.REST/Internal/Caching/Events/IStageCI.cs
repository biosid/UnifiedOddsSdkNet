...
namespace Sportradar.OddsFeed.SDK.Entities.REST.Internal.Caching.Events
{
    ...
    public interface IStageCI : ICompetitionCI
    {
        ...
        /// <summary>
        ///     Asynchronously gets a <see cref="StageCI" /> representing the parent stage of the current instance or a null
        ///     reference if the represented stage does not have the parent stage
        /// </summary>
        /// <param name="cultures">
        ...
        /// <summary>
        ///     Asynchronously gets a <see cref="IEnumerable{StageCI}" /> representing child stages of the current instance or a
        ///     null reference if the represented stage does not have childs
        /// </summary>
