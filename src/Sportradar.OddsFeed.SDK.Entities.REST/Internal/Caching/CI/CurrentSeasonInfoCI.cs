    ...
    public class CurrentSeasonInfoCI : CacheItem
    {
            ...
            : base(dto.Id, dto.Name, culture)
        {
            ...
            Competitors = dto.Competitors == null
                ? null
                : dto.Competitors.Select(s => new CompetitorCI(s, culture, _dataRouterManager));
        ...
        /// <summary>
        ///     Gets the <see cref="SeasonCoverageCI" /> instance containing information about coverage available for the season
        ///     associated with the current instance
        /// </summary>
        /// <returns>
        ///     The <see cref="SeasonCoverageCI" /> instance containing information about coverage available for the season
        ///     associated with the current instance
        /// </returns>
        public SeasonCoverageCI SeasonCoverage { get; private set; }

        /// <summary>
        ///     Gets the <see cref="IEnumerable{T}" /> specifying groups of tournament associated with the current instance
        /// </summary>
        ...
        public void Merge(CurrentSeasonInfoDTO dto, CultureInfo culture)
        {
            ...
            if (dto.SeasonCoverage != null) SeasonCoverage = new SeasonCoverageCI(dto.SeasonCoverage);
            if (dto.Groups != null) Groups = dto.Groups.Select(s => new GroupCI(s, culture, _dataRouterManager));
            if (dto.CurrentRound != null) CurrentRound = new RoundCI(dto.CurrentRound, culture);
