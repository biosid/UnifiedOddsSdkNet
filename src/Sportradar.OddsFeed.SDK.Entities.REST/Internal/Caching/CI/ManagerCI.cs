...
namespace Sportradar.OddsFeed.SDK.Entities.REST.Internal.Caching.CI
{
    ...
    public class ManagerCI : CacheItem
    {
            ...
            : base(item.Id, item.Name, culture)
        {
            ...
            if (Nationality == null) Nationality = new Dictionary<CultureInfo, string>();
        ...
        /// <summary>
        ///     Gets a <see cref="IDictionary{TKey,TValue}" /> containing translated nationality of the item
        /// </summary>
