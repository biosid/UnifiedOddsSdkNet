...
namespace Sportradar.OddsFeed.SDK.Entities.REST.Internal.Caching.CI
{
    ...
    {
        /// <summary>
        ///     A <see cref="IDictionary{TKey,TValue}" /> containing season names in different languages
        /// </summary>
        ...
        public void Merge(SeasonCI season)
        {
            ...
            EndDate = season.EndDate;
            Year = season.Year;
            foreach (var cultureName in season._name) _name[cultureName.Key] = cultureName.Value;
        }
    }
}