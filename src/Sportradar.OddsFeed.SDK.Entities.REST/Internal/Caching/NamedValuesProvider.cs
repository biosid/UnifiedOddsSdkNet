...
namespace Sportradar.OddsFeed.SDK.Entities.REST.Internal.Caching
{
    ...
    internal class NamedValuesProvider : INamedValuesProvider
    {
        ...
        /// <param name="matchStatuses">
        ///     The <see cref="ILocalizedNamedValueCache" /> providing localized(translatable) match status
        ///     descriptions.
        /// </param>
        public NamedValuesProvider(INamedValueCache voidReasons, INamedValueCache betStopReasons,
            INamedValueCache bettingStatuses, ILocalizedNamedValueCache matchStatuses)
        {
