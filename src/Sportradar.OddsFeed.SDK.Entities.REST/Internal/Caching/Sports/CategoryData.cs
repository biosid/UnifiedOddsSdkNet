...
namespace Sportradar.OddsFeed.SDK.Entities.REST.Internal.Caching.Sports
{
    ...
    {
        /// <summary>
        ///     Gets the <see cref="IEnumerable{T}" /> representing the ids of tournaments, which belong to category represented by
        ...
        ///     the <see cref="IEnumerable{URN}" /> representing the tournaments, which belong to the
        ///     category
        /// </param>
        public CategoryData(URN id, IReadOnlyDictionary<CultureInfo, string> names, string countryCode,
            IEnumerable<URN> tournaments)
            : base(id, names)
        {
