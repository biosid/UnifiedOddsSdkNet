...
{
    /// <summary>
    ///     Defines a contract implemented by classes used POST request to obtain <see cref="HttpResponseMessage" /> instance
    ///     containing status code and data
    /// </summary>
    public interface IDataPoster
    {
        /// <summary>
        ///     Asynchronously gets a <see cref="HttpResponseMessage" /> as a result of POST request send to the provided
        ///     <see cref="Uri" />
        /// </summary>
        ...
        /// <returns>
        ///     A <see cref="Task" /> which, when completed will return a <see cref="HttpResponseMessage" /> containing status
        ///     code and data
        /// </returns>
