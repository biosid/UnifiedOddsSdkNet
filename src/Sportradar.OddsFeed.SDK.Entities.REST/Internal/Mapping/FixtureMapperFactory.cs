...
namespace Sportradar.OddsFeed.SDK.Entities.REST.Internal.Mapping
{
    ...
    {
        /// <summary>
        ///     Creates and returns a <see cref="ISingleTypeMapper{T}" /> instance used to map <see cref="fixturesEndpoint" />
        ///     instances to <see cref="FixtureDTO" /> instances
        /// </summary>
        /// <param name="data">A <see cref="fixturesEndpoint" /> instance containing fixture data</param>
        /// <returns>
        ///     a <see cref="ISingleTypeMapper{T}" /> instance used to map <see cref="fixturesEndpoint" /> instances to
        ///     <see cref="FixtureDTO" /> instances
        /// </returns>
