...
{
    /// <summary>
    ///     A factory used to create <see cref="ISingleTypeMapper{T}" /> instances used to map <see cref="producers" />
    ///     instances to
    ...
    {
        /// <summary>
        ///     Creates and returns a <see cref="ISingleTypeMapper{T}" /> instance used to map <see cref="producers" /> instances
        ///     to
