...
namespace Sportradar.OddsFeed.SDK.Entities.REST.Internal.Mapping
{
    ...
    public class
        CompetitorProfileMapperFactory : ISingleTypeMapperFactory<competitorProfileEndpoint, CompetitorProfileDTO>
    {
        /// <summary>
        ///     Creates and returns a <see cref="ISingleTypeMapper{T}" /> instance used to map
        ///     <see cref="competitorProfileEndpoint" /> instances to <see cref="CompetitorProfileDTO" /> instances
        /// </summary>
        /// <param name="data">A <see cref="competitorProfileEndpoint" /> instance containing fixture data</param>
        /// <returns>
        ///     a <see cref="ISingleTypeMapper{T}" /> instance used to map <see cref="competitorProfileEndpoint" /> instances
