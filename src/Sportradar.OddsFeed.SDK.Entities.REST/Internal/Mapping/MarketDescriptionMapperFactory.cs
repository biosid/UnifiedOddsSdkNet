...
namespace Sportradar.OddsFeed.SDK.Entities.REST.Internal.Mapping
{
    ...
    {
        /// <summary>
        ///     Creates and returns a <see cref="T:Sportradar.OddsFeed.SDK.Entities.REST.Internal.Mapping.ISingleTypeMapper`1" />
        ///     instance
        /// </summary>
        /// <param name="data">
        ///     A <see cref="!:TIn" /> instance which the created
        ///     <see cref="T:Sportradar.OddsFeed.SDK.Entities.REST.Internal.Mapping.ISingleTypeMapper`1" /> will map
        /// </param>
