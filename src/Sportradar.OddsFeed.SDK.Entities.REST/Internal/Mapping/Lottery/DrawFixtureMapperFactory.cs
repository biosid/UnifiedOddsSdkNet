...
namespace Sportradar.OddsFeed.SDK.Entities.REST.Internal.Mapping.Lottery
{
    ...
    internal class DrawFixtureMapperFactory : ISingleTypeMapperFactory<draw_fixtures, DrawDTO>
    {
        /// <summary>
        ///     Creates and returns a <see cref="ISingleTypeMapper{DrawDTO}" /> instance
        /// </summary>
        /// <param name="data">
        ///     A <see cref="RestMessage" /> instance which the created <see cref="ISingleTypeMapper{DrawDTO}" />
        ///     will map
        /// </param>
        /// <returns>New <see cref="ISingleTypeMapper{DrawDTO}" /> instance</returns>
        public ISingleTypeMapper<DrawDTO> CreateMapper(draw_fixtures data)
        {
            return new DrawFixtureMapper(data);
        }
    }
}