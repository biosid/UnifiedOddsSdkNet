...
namespace Sportradar.OddsFeed.SDK.Entities.REST.Internal.Mapping
{
    ...
    public class TournamentsMapper : ISingleTypeMapper<EntityList<SportDTO>>
    {
        ...
        private static readonly IEqualityComparer<tournamentExtended> EqualityComparer =
            new TournamentBySportIdEqualityComparer();
        ...
        ///     <see cref="tournamentsEndpoint" /> instances
        ///     to <see cref="EntityList{SportDTO}" /> instances
        /// </summary>
        /// <param name="data">A <see cref="tournamentsEndpoint" /> instance containing tournaments data</param>
        /// <returns>
        ///     a new instance of the <see cref="ISingleTypeMapper{T}" /> instance used to map <see cref="tournamentsEndpoint" />
        ///     instances
        ///     to <see cref="EntityList{SportDTO}" /> instances
        /// </returns>
