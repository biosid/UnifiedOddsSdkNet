...
namespace Sportradar.OddsFeed.SDK.Entities.REST.Internal.Mapping
{
    ...
    {
        /// <summary>
        ///     Creates and returns a <see cref="ISingleTypeMapper{T}" /> instance used to map <see cref="playerProfileEndpoint" />
        ///     instances to <see cref="PlayerProfileDTO" /> instances
        /// </summary>
        /// <param name="data">A <see cref="playerProfileEndpoint" /> instance containing fixture data</param>
        /// <returns>
        ///     a <see cref="ISingleTypeMapper{T}" /> instance used to map <see cref="playerProfileEndpoint" /> instances to
        ///     <see cref="PlayerProfileDTO" /> instances
        /// </returns>
