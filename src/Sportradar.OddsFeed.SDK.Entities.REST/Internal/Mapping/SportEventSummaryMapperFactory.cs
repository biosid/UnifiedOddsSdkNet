...
namespace Sportradar.OddsFeed.SDK.Entities.REST.Internal.Mapping
{
    ...
    public class SportEventSummaryMapperFactory : ISingleTypeMapperFactory<RestMessage, SportEventSummaryDTO>
    {
        ...
        /// </summary>
        /// <param name="data">
        ///     A <see cref="RestMessage" /> instance which the created
        ///     <see cref="ISingleTypeMapper{SportEventSummaryDTO}" /> will map
        /// </param>
        ...
        public ISingleTypeMapper<SportEventSummaryDTO> CreateMapper(RestMessage data)
        {
            ...
            if (match != null) return new SportEventSummaryMapper(match);
            var stage = data as stageSummaryEndpoint;
            if (stage != null) return new SportEventSummaryMapper(stage);
            var tour = data as tournamentInfoEndpoint;
            if (tour != null) return new SportEventSummaryMapper(tour);
