...
namespace Sportradar.OddsFeed.SDK.Entities.REST.Contracts
{
    ...
    internal abstract class MarketDescriptionCacheContract : IMarketDescriptionCache
    {
        public Task<IMarketDescription> GetMarketDescriptionAsync(int marketId, string variant,
