...
namespace Sportradar.OddsFeed.SDK.Entities.REST
{
    ...
    public interface IMatch : ICompetition
    {
        ...
        /// <summary>
        ///     Asynchronously gets a <see cref="ITeamCompetitor" /> representing home competitor of the match associated with the
        ///     current instance
        /// </summary>
        ...
        /// <summary>
        ///     Asynchronously gets a <see cref="ITeamCompetitor" /> representing away competitor of the match associated with the
        ///     current instance
        /// </summary>
        /// <returns>A <see cref="Task{ITeamCompetitor}" /> representing the retrieval operation</returns>
        ...
        /// <summary>
        ///     Asynchronously gets a <see cref="ISeasonInfo" /> representing the season to which the sport event associated with
        ///     the current instance belongs to
        /// </summary>
        /// <returns>A <see cref="Task{ISeasonInfo}" /> representing the retrieval operation</returns>
        Task<ISeasonInfo> GetSeasonAsync();

        /// <summary>
        ///     Asynchronously gets a <see cref="IRound" /> representing the tournament round to which the sport event associated
        ///     with the current instance belongs to
        /// </summary>
        /// <returns>A <see cref="Task{IRound}" /> representing the retrieval operation</returns>
        Task<IRound> GetTournamentRoundAsync();

        /// <summary>
        ///     Asynchronously gets a <see cref="ILongTermEvent" /> representing the season to which the sport event associated
        ///     with the current instance belongs to
        /// </summary>
