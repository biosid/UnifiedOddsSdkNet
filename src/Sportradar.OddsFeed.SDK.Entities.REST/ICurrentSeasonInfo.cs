...
namespace Sportradar.OddsFeed.SDK.Entities.REST
{
    ...
    public interface ICurrentSeasonInfo
    {
        ...
        /// <summary>
        ///     Gets the <see cref="ISeasonCoverage" /> instance containing information about coverage available for the season
        ///     associated with the current instance
        /// </summary>
        /// <returns>
        ///     The <see cref="ISeasonCoverage" /> instance containing information about coverage available for the season
        ///     associated with the current instance
        /// </returns>
