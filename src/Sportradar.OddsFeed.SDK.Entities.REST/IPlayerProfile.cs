...
namespace Sportradar.OddsFeed.SDK.Entities.REST
{
    ...
    public interface IPlayerProfile : IPlayer
    {
        ...
        /// <summary>
        ///     Gets a <see cref="IReadOnlyDictionary{TKey,TValue}" /> containing player nationality in different languages
        /// </summary>
        [DataMember]
        IReadOnlyDictionary<CultureInfo, string> Nationalities { get; }

        /// <summary>
        ///     Gets the nationality of the player represented by the current instance in  the language specified by
        ///     <code>culture</code>
        /// </summary>
